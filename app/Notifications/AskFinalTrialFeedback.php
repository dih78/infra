...
class AskFinalTrialFeedback extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject("Your Infra trial ends soon - We'd love your final feedback")
            ->greeting("Hello {$this->team->owner->name}!")
            ->line("Your Infra trial for team {$this->team->name} is ending soon.")
            ->line("You will not be able to use Infra after {$trialEndsAt->toDateTimeString()} ({$dateDiff}).")
            ->line('Before your trial ends, we\'d greatly appreciate your final thoughts.')
            ->line('Your feedback is crucial in helping us improve Infra for you and future users.')
            ->line('Please reply to this email with your experience and any suggestions you might have.')
            ->line('Thank you for trying Infra. We hope you\'ve found it valuable!')
            ->line('If you\'re interested in continuing with Infra, please visit our pricing page to choose a plan that suits your needs.')
