...
class AskMidTrialFeedback extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        $message = (new MailMessage)
            ->subject('We\'d love your feedback on Infra')
            ->greeting("Hello {$this->team->owner->name}!")
            ->line('We hope you\'re enjoying your experience with Infra so far.')
        ...
        if ($nodeCount === 0) {
            ...
            $message->line('It looks like you\'re actively using Infra with multiple custom services. We\'d love to hear about your experience and any suggestions you might have for improvements.');
        }
