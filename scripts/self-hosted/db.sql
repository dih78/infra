...
2	1	2	{"processes": [{"name": "pg", "caddy": [], "ports": [], "backups": [], "command": null, "envVars": [{"name": "POSTGRESQL_USERNAME", "value": "ptah_sh"}, {"name": "POSTGRESQL_PASSWORD", "value": "ptah_sh"}, {"name": "POSTGRESQL_DATABASE", "value": "ptah_sh"}], "fastCgi": null, "volumes": [{"id": "volume-q7r8s9t0a1", "name": "data", "path": "/bitnami/postgresql", "dockerName": "svc_2_ptah_pg_data", "backupSchedule": null}], "workers": [], "replicas": 1, "dockerName": "svc_2_ptah_pg", "launchMode": "daemon", "secretVars": [], "configFiles": [], "dockerImage": "bitnami/postgresql:16", "healthcheck": {"command": null, "retries": 3, "timeout": 5, "interval": 10, "startPeriod": 30, "startInterval": 5}, "secretFiles": [], "backupVolume": {"id": "volume-h7i8j9k0l1", "name": "backups", "path": "/ptah/backups", "dockerName": "svc_2_ptah_pg_ptah_backups"}, "rewriteRules": [], "redirectRules": [], "releaseCommand": {"command": null, "dockerName": null}, "placementNodeId": 1, "dockerRegistryId": null}, {"name": "pool", "caddy": [], "ports": [], "backups": [], "command": null, "envVars": [{"name": "PGBOUNCER_POOL_MODE", "value": "session"}, {"name": "POSTGRESQL_USERNAME", "value": "ptah_sh"}, {"name": "POSTGRESQL_PASSWORD", "value": "ptah_sh"}, {"name": "POSTGRESQL_DATABASE", "value": "ptah_sh"}, {"name": "POSTGRESQL_HOST", "value": "pg.server.ptah.local"}, {"name": "PGBOUNCER_PORT", "value": "6432"}, {"name": "PGBOUNCER_DATABASE", "value": "ptah_sh"}], "fastCgi": null, "volumes": [], "workers": [], "replicas": 1, "dockerName": "svc_2_ptah_pool", "launchMode": "daemon", "secretVars": [], "configFiles": [], "dockerImage": "bitnami/pgbouncer", "healthcheck": {"command": null, "retries": 3, "timeout": 5, "interval": 10, "startPeriod": 30, "startInterval": 5}, "secretFiles": [], "backupVolume": null, "rewriteRules": [], "redirectRules": [], "releaseCommand": {"command": null, "dockerName": null}, "placementNodeId": null, "dockerRegistryId": null}, {"name": "app", "caddy": [{"id": "caddy-b2c3d4e5f6", "path": "/*", "domain": "ptah.localhost", "targetPort": 8080, "publishedPort": 80, "targetProtocol": "http"}], "ports": [], "backups": [], "command": null, "envVars": [{"name": "APP_ENV", "value": "production"}, {"name": "APP_KEY", "value": "base64:APP_KEY"}, {"name": "BCRYPT_ROUNDS", "value": "12"}, {"name": "DB_CONNECTION", "value": "pgsql"}, {"name": "DB_HOST", "value": "pool.server.ptah.local"}, {"name": "DB_DATABASE", "value": "ptah_sh"}, {"name": "DB_USERNAME", "value": "ptah_sh"}, {"name": "DB_PASSWORD", "value": "ptah_sh"}, {"name": "LOG_CHANNEL", "value": "errorlog"}, {"name": "APP_URL", "value": "localhost"}, {"name": "BILLING_ENABLED", "value": "true"}], "fastCgi": null, "volumes": [], "workers": [{"name": "schedule", "command": "php artisan config:cache && php artisan schedule:work", "replicas": 1, "dockerName": "svc_2_ptah_app_wkr_schedule"}, {"name": "queue", "command": "php artisan config:cache && php artisan queue:work", "replicas": 1, "dockerName": "svc_2_ptah_app_wkr_queue"}], "replicas": 2, "dockerName": "svc_2_ptah_app", "launchMode": "daemon", "secretVars": [], "configFiles": [], "dockerImage": "dih78/infraimg:latest", "healthcheck": {"command": null, "retries": 3, "timeout": 5, "interval": 10, "startPeriod": 30, "startInterval": 5}, "secretFiles": [], "backupVolume": null, "rewriteRules": [], "redirectRules": [], "releaseCommand": {"command": "php artisan config:cache && php artisan migrate --no-interaction --verbose --ansi --force", "dockerName": "svc_2_dpl_2_release_command"}, "placementNodeId": null, "dockerRegistryId": null}], "networkName": "ptah_net", "internalDomain": "server.ptah.local"}	2024-09-01 00:00:00	2024-09-01 00:00:00
\.
...
13	1	3	14	{"dockerImage": "dih78/infraimg:latest"}	{"Image": "dih78/infraimg:latest", "PullOptions": {"IgnorePullFailure": true, "PullAlways": false}, "AuthConfigName": ""}	completed	2024-09-01 00:00:00	2024-09-01 00:00:00	[]	2024-09-01 00:00:00	2024-09-01 00:00:00
...
1	Self Host	admin@localhost	2024-09-01 00:00:00	self_hosted_password	\N	1	\N	2024-09-01 00:00:00	2024-09-01 00:00:00	\N	\N	\N
\.
